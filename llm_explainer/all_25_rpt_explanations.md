# All 25 RPT Explanations - Meta-Llama-3.1-8B-Instruct

Local markdown bundle generated from `llm_explainer/shap_sample_reports.jsonl` using the best-performing local explainer model.
