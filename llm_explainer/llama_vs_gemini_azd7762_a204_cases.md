# AZD7762 / A-204 Gemini Baseline Cases

This file stores the exact prompts and Gemini responses used for the Llama vs
Gemini same-prompt comparison.

<!-- CASE {"id":"real_features","label":"Condition #2: real features","probe":"sanity_check","allowed_genes":["MGP","COL11A1","PRRX1","DNER","CP","CHEK1","CHEK2"],"allowed_evidence_tags":["MGP","COL11A1","PRRX1","DNER","CP","CHEK1","CHEK2","CHEK1;CHEK2"],"required_sentence_count":3} -->
## Prompt
```text
...
<!-- CASE {"id":"shuffled_features","label":"Condition #3: shuffled features","probe":"shuffled_features","allowed_genes":["WAS","LPAR1","C6orf132","TRPV2","LDHB","CHEK1","CHEK2"],"allowed_evidence_tags":["WAS","LPAR1","C6orf132","TRPV2","LDHB","CHEK1","CHEK2","CHEK1;CHEK2"],"required_sentence_count":3} -->
## Prompt
```text
You are a clinical bioinformatics analyst generating a structured drug sensitivity rationale.
...
<!-- CASE {"id":"wrong_drug","label":"Condition #4: wrong drug","probe":"wrong_drug","allowed_genes":["MGP","COL11A1","PRRX1","DNER","CP","EHMT1","EHMT2"],"allowed_evidence_tags":["MGP","COL11A1","PRRX1","DNER","CP","EHMT1","EHMT2","EHMT1;EHMT2"],"required_sentence_count":3} -->
## Prompt
```text
You are a clinical bioinformatics analyst generating a structured drug sensitivity rationale.
